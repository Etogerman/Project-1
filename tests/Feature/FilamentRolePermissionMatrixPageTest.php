...
class FilamentRolePermissionMatrixPageTest extends TestCase
{
    ...
    public function test_superadmin_can_open_role_permission_matrix_page(): void
    {
        ...
        $this->actingAs($superadmin)
            ...
            ->assertSee('contacts.delete')
            ->assertSee('dialogs.view')
            ->assertSee('dialogs.edit')
            ->assertSee('tags.view')
            ...
            ->assertDontSee('dialogs.delete')
            ->assertDontSee('users.delete')
            ->assertDontSee('channels.delete')
            ->assertDontSee('bitrix24.edit')
            ->assertDontSee('bitrix24.delete')
