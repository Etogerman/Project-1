...
class AdminDialogNotificationsTest extends TestCase
{
    ...
    public function test_admin_topbar_renders_dialog_notifications_bootstrap(): void
    {
        ...
        $response
            ...
            ->assertSee('const compareChronology', false)
            ->assertSee('latestNotificationMessageId === lastSoundMessageId', false)
            ->assertSee('state.latest_notification_sort_at ?? null', false)
            ->assertSee('allowSound: options.allowSound !== false', false)
            ...
            ->assertSee('return await navigator.locks.request', false)
            ->assertSee('playCoordinatedSound(latestNotificationMessageId)', false)
            ->assertSee('.then((handled) => {', false)
            ->assertSee('rememberLatestNotification();', false)
