...
class EngineFieldRegistry
{
    ...
    private const CONTACT_FIELDS = [
        ...
        'emails' => ['readable' => true, 'writable' => false, 'type' => 'email'],
        ...
        'duplicate_review_status' => ['readable' => true, 'writable' => false, 'type' => 'select'],
        'merged_into_contact_id' => ['readable' => true, 'writable' => false, 'type' => 'number'],
        'merged_at' => ['readable' => true, 'writable' => false, 'type' => 'date'],
        'merge_reason' => ['readable' => true, 'writable' => false, 'type' => 'select'],
        'merge_trigger_phone' => ['readable' => true, 'writable' => false, 'type' => 'phone'],
        ...
        'bitrix24_linked_at' => ['readable' => true, 'writable' => false, 'type' => 'date'],
        'bitrix24_sync_pending' => ['readable' => true, 'writable' => false, 'type' => 'boolean'],
        'bitrix24_sync_fingerprint' => ['readable' => true, 'writable' => false, 'type' => 'text'],
        ...
        'bitrix24_deal_linked_at' => ['readable' => true, 'writable' => false, 'type' => 'date'],
        'bitrix24_deal_sync_pending' => ['readable' => true, 'writable' => false, 'type' => 'boolean'],
        ...
        'bitrix24_history_sync_pending' => ['readable' => true, 'writable' => false, 'type' => 'boolean'],
    ...
    private const DIALOG_FIELDS = [
        ...
        'phone' => ['readable' => true, 'writable' => false, 'type' => 'phone'],
        'external_username' => ['readable' => true, 'writable' => false, 'type' => 'text'],
