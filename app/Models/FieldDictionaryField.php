...
class FieldDictionaryField extends Model
{
    ...
    protected static function dialogSystemDefinitions(): array
    {
        return [
            ...
            self::definition(self::ENTITY_DIALOG, 'last_inbound_message_at', 'Последнее входящее сообщение', self::TYPE_DATE, 105),
            self::definition(self::ENTITY_DIALOG, 'last_outbound_message_at', 'Последнее исходящее сообщение', self::TYPE_DATE, 106),
            self::definition(self::ENTITY_DIALOG, 'last_inbound_message_id', 'Последнее входящее сообщение', self::TYPE_NUMBER, 110),
            self::definition(self::ENTITY_DIALOG, 'last_outbound_message_id', 'Последнее исходящее сообщение', self::TYPE_NUMBER, 120),
