...
trait InteractsWithContactWorkspace
{
    ...
    public function claimMountedContact(): void
    {
        ...
        $record = $this->resolveWorkspaceContactOrNotify('Не удалось взять контакт в работу');
    ...
    public function releaseMountedContact(): void
    {
        ...
        $record = $this->resolveWorkspaceContactOrNotify('Не удалось снять контакт с работы');
    ...
    public function openAssignContactDialog(): void
    {
        ...
        $record = $this->resolveWorkspaceContactOrNotify('Не удалось открыть выбор ответственного');
    ...
    public function openAddTagDialog(): void
    {
        ...
        $record = $this->resolveWorkspaceContactOrNotify('Не удалось открыть выбор тега');
    ...
    public function saveMountedContactAssignee(): void
    {
        ...
        $record = $this->resolveWorkspaceContactOrNotify('Не удалось сохранить ответственного');
    ...
    public function openEditPhoneDialog(int|string $phoneId): void
    {
        ...
        try {
            $phoneNumber = $this->resolveWorkspaceContactPhoneNumber($phoneId);
    ...
    public function openEditProfileDialog(): void
    {
        ...
        $record = $this->resolveWorkspaceContactOrNotify('Не удалось открыть редактирование профиля');
    ...
    public function saveMountedContactPhone(): void
    {
        ...
        try {
            ...
            $phoneNumber = $this->resolveWorkspaceContactPhoneNumber($this->editingPhoneId);
    ...
    public function openDeleteContactDialog(): void
    {
        ...
        $record = $this->resolveWorkspaceContactOrNotify('Не удалось открыть удаление контакта');
    ...
    public function deleteMountedContact(): void
    {
        ...
        try {
            ...
            $this->clearWorkspaceContactAfterDelete();
        } catch (Throwable $throwable) {
            Notification::make()
                ->danger()
    ...
    public function deleteMountedContactPhone(): void
    {
        ...
        try {
            ...
            $phoneNumber = $this->resolveWorkspaceContactPhoneNumber($this->deletingPhoneId);
    ...
    protected function setMountedContactAutoReplyEnabled(bool $isEnabled): void
    {
        ...
        $record = $this->resolveWorkspaceContactOrNotify('Не удалось обновить автоответы');
    ...
    protected function resolveWorkspaceContactPhoneNumber(int|string $phoneId): ContactPhoneNumber
    {
        $record = $this->resolveWorkspaceContact();
    ...
    protected function replaceWorkspaceContactWithEffectiveContact(Contact $contact): void
    {
        ...
        $this->syncWorkspaceContact($effectiveContact);
    }
    ...
    abstract protected function resolveWorkspaceContact(): ?Contact;

    abstract protected function syncWorkspaceContact(Contact $contact): void;

    abstract protected function clearWorkspaceContactAfterDelete(): void;
}
