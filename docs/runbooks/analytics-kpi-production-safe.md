# Production-safe KPI SQL runbook
...
4. Указать абсолютные даты, а не относительные формулировки.
...
Пример для периода 2026-07-01 - 2026-07-07:
...
psql "$DATABASE_URL" \
  ...
  -v sla_cutoff="'2026-07-07 22:59:59'" \
