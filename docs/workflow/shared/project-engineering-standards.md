...
- Код приложения и комментарии в коде — английские; UI и документация — русские.
- Общение, commit messages, PR title/body и GitHub-комментарии — русские, кроме
  команд, путей, имён workflow, дословных логов и терминов без точного перевода.
- Ветки используют префикс `codex/`, ASCII-транслитерацию русского смысла и не
  содержат кириллицу.
