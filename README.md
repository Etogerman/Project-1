...
Основной проект не хранит живые указатели на версии ТЗ и не хранит реестр активных работ. Для конкретной работы актуальные `Spec doc` и `Spec revision` фиксируются во внешнем репозитории документации, в описании задачи или в PR.
